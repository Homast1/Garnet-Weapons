CustomizableWeaponry:addFireSound("CW_G3A3_FIRE", "weapons/cw_g3a3/fire.wav", 1, 125, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_G3A3_FIRE_SUPPRESSED", "weapons/cw_g3a3/fire_suppressed.wav", 1, 105, CHAN_STATIC)
